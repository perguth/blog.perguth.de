const socialIcons = {
  ...
  >
    ...
    <path
      d="M12 6v12m3.5 -9h-7m7 3h-7m7 3h-7"
      stroke="#fff"
      stroke-width="1.5"
    ></path>
  </svg>`,
  ...
  Bluesky: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 17.67">
  <path d="M4.524 1.468c2.216 1.664 4.6 5.038 5.476 6.849 0.875-1.811 3.259-5.185 5.476-6.849 1.599-1.201 4.19-2.13 4.19 0.826 0 0.59-0.338 4.96-0.537 5.669-0.69 2.466-3.205 3.095-5.442 2.714 3.91 0.666 4.905 2.87 2.757 5.074-4.08 4.186-5.864-1.05-6.321-2.392-0.084-0.246-0.123-0.361-0.124-0.263-0.001-0.098-0.04 0.017-0.124 0.263-0.457 1.342-2.241 6.578-6.321 2.392-2.148-2.204-1.153-4.408 2.757-5.074-2.237 0.381-4.752-0.248-5.442-2.714-0.199-0.709-0.537-5.079-0.537-5.669 0-2.956 2.591-2.027 4.19-0.826z" fill="#1185fe"></path>
</svg>`,
};
